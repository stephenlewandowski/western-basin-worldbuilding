...
- Figures: `../outputs/figures/phase16b_compound_stress_propagation.png/.svg` and `phase16b_technology_regime_effects.png/.svg`; both are qualitative, non-geographic, non-proportional, and non-ranked. The package uses only frozen Phase 16A propagation rules and frozen Phase 15A/15B technology-regime references; Phase 17 remains **NOT IMPLEMENTED**.

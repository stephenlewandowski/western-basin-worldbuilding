...
- Reports and checks: `phase16a_integrated_basin_dynamics.md`, `phase16a_propagation_framework.md`, `phase16a_candidate_stress_tests.md`, `phase16a_qa.md`, `phase16a_manifest.json`, `phase16a_artifact_check.json`, and `phase16a_r_validation_result.json`; validators are `../src/python/systems/validate_phase16a_dynamics.py` and `../src/R/systems/validate_phase16a_dynamics.R`.

# Phase 2A–2B Geology / Minerals / Material Flows Sources

Retrieved: 2026-08-29

Baseline year: 2026

Scope: 2026 geology, facility, carbonate-flow, and beryllium supply-chain baseline; no future scenario or speculative corridor geometry.

The complete Phase 2B machine-readable registry is `data/processed/networks/materials_system_sources.csv`. It contains 14 records with source ID, title, publisher, URL/identifier, retrieval date, publication/dataset date, scale, terms, confidence, source type, and interpretation limits.
...
## Phase 2B relationship sources

| source_id | source | evidence used | classification limit |
|---|---|---|---|
| `SRC-EPA-CAO-2023` | [US EPA, Calcium Oxide Supply Chain Profile](https://www.epa.gov/system/files/documents/2023-03/Calcium%20Oxide%20Supply%20Chain%20Profile.pdf) | Limestone/dolomite-to-lime chain and broad water, wastewater, industrial, construction, and remediation functions | Generalized engineering dependency only; not a local supplier-to-Toledo claim |
| `SRC-MM-WOODVILLE-2025` | [Martin Marietta, 2025 Sustainability Report](https://mcdn.martinmarietta.com/assets/sustainability/2025sustainabilityreport.pdf) and official Woodville facility page | Six Woodville lime kilns and dolomitic-limestone processing | Company statement; no production volume transferred |
| `SRC-KOKOSING-WOODVILLE-2026` | [Kokosing/Olen specialty aggregates](https://www.kokosing.biz/our-work/materials/aggregate/specialty/) | Woodville agricultural lime and filter sand | Product evidence, not customer or route evidence |
| `SRC-GRAYMONT-GENOA-2026` | [Graymont solutions](https://www.graymont.com/solutions/) and contact page | Genoa lime processing and broad lime applications | Company statement; no named downstream buyer inferred |
| `SRC-USGS-BE-2026` | [USGS Mineral Commodity Summaries 2026 — Beryllium](https://pubs.usgs.gov/periodicals/mcs2026/mcs2026-beryllium.pdf) | Utah-derived and imported feed; intermediate shipment to Ohio; broad uses | National-scale summary; no mine-to-Elmore route or tonnage modeled |
| `SRC-USGS-BE-FLOW-2018` | [USGS beryllium economic geology and material flow](https://www.usgs.gov/centers/geology-energy-and-minerals-science-center/science/beryllium-economic-geology-material-flow) | Broad supply-chain and sector structure | Schematic relationship only |
| `SRC-MATERION-CFS-2025` | [Materion–Commonwealth Fusion Systems supply agreement](https://www.materion.com/en/about-materion/news/performance-alloys/materion-supply-agreement-with-commonwealth-fusion) | 31 October 2025 announcement; Elmore beryllium fluoride for CFS ARC FLiBe | `documented_supply_relationship`; company statement, no quantity/route or regional reactor inferred |
| `SRC-MATERION-KAIROS-2022` | [Materion–Kairos Power collaboration](https://investor.materion.com/news/news-details/2022/Materion-and-Kairos-Power-to-Advance-Clean-Energy/default.aspx) | 27 July 2022 Elmore purification/FLiBe collaboration | Documented relationship; 2026 operating status unresolved |
| `SRC-EPA-MATERION-ELMORE` | [US EPA Materion Elmore permit documentation](https://semspub.epa.gov/work/05/967810.pdf) | Government-verified Elmore processing location and role | Does not identify local extraction; model explicitly sets it false |
| `SRC-USACE-LUCKEY-2026` | [USACE Luckey Site](https://www.lrd.usace.army.mil/Missions/Projects/Article/3613204/luckey-site/) | Current FUSRAP cleanup and historical context | Legacy/remediation only, not current production |

Commercial statements are labeled `company_statement` in the registry. Government datasets, permits, and federal project records are labeled `government_verified`. Retrieval dates preserve the actual Phase 2A/2B source-acquisition date of 2026-08-29.

...
DEPS = [
    ...
    ["GDEP-002", "Water", "Water", "GA-002", "GA-004", "permit", "operate", "permit_dependency", "permit", "mandatory", "documented", "state / public utility", "high", "s02_ohio_pws", "Ohio EPA public-water requirements constrain the operator; permitting is not physical operation."],
    ...
    ["GDEP-011", "Climate / Natural Hazards", "Climate / Natural Hazards", "GA-006", "GA-038", "warn", "plan", "emergency_coordination", "emergency protocol", "unknown", "inferred", "federal / county", "moderate", "s35_fema_mitigation", "Warnings and county mitigation planning meet as a coordination interface; no command structure is modeled."],
    ...
    ["GDEP-014", "Ecology / Biodiversity", "Ecology / Biodiversity", "GA-008", "GA-002", "permit", "permit", "overlapping_authority", "permit", "mandatory", "documented", "federal / state", "high", "s07_usace_regulatory", "Federal aquatic permitting and Ohio 401/isolated-wetland programs can overlap by activity and authority; no blanket priority is inferred."],
    ...
    ["GDEP-026", "Environmental Health / Exposure", "Water", "GA-040", "GA-004", "regulate", "operate", "permit_dependency", "statute/regulation", "mandatory", "inferred", "state / public utility", "limited", "s38_odh", "Private-water health regulation is distinct from municipal public-water operation; no municipal jurisdiction is reassigned."],
]
